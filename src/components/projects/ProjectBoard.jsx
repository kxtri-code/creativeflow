...
const ProjectBoard = () => {
  ...
  useEffect(() => {
    ...
    if (savedTasks) {
      ...
      // Mock Data
      const mockTasks = [
        { id: 1, title: 'Design System Update', description: 'Update color palette and typography.', status: 'To Do', priority: 'High', dueDate: '2024-03-20', assignees: ['u1'], tags: ['Design', 'UI'], comments: [] },
        { id: 2, title: 'API Integration', description: 'Connect frontend to backend endpoints.', status: 'In Progress', priority: 'Urgent', dueDate: '2024-03-18', assignees: ['u2'], tags: ['Dev', 'Backend'], comments: [] },
        { id: 3, title: 'Client Presentation', description: 'Prepare slides for Q1 review.', status: 'Review', priority: 'Medium', dueDate: '2024-03-25', assignees: ['u3', 'u4'], tags: ['Meeting'], comments: [] },
      ];
      setTasks(mockTasks);
