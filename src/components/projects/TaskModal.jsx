...
import { X, Calendar, User, Tag, MessageSquare, Send, Clock, Flag, CheckCircle } from 'lucide-react';
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 relative">
                    <input 
                      ...
                      className="w-full pl-4 pr-10 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 outline-none"
                    />
                    <button 
                      onClick={addComment}
                      className="absolute right-2 top-2 text-indigo-600 hover:text-indigo-700 p-1"
                    >
                      <Send size={16} />
                    </button>
                  </div>
