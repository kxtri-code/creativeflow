    ...
    <div className="h-[calc(100vh-8rem)] flex flex-col">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 bg-white text-slate-700 border border-slate-200 rounded-xl font-medium hover:bg-slate-50 transition-all flex items-center gap-2">
            <Settings size={18} /> Settings
          </button>
          <button className="px-4 py-2 bg-slate-900 text-white rounded-xl font-medium shadow-lg shadow-slate-900/20 hover:bg-slate-800 transition-all">
            Generate Report
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6 flex-1 min-h-0">
        ...
        <div className="col-span-12 lg:col-span-4 h-[500px] flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="glass-card p-4 hover:bg-indigo-50 transition-colors text-left group">
          ...
          <div className="glass-card flex-1 p-4 bg-gradient-to-br from-white to-indigo-50/30">
            ...
            <button className="w-full mt-auto py-2 text-xs font-bold text-indigo-600 hover:text-indigo-700 mt-4">
              Open Team Chat
            </button>
          </div>
        </div>
